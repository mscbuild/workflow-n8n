...
LABEL org.opencontainers.image.title="n8n Workflows Collection" \
      org.opencontainers.image.description="Collection of n8n workflows for automation, integrations, and AI-powered processes." \
      org.opencontainers.image.version="1.0.0" \
      org.opencontainers.image.authors="mscbuild" \
      org.opencontainers.image.url="https://github.com/mscbuild/n8n-workflows" \
      org.opencontainers.image.source="https://github.com/mscbuild/n8n-workflows" \
      org.opencontainers.image.licenses="MIT" \
      org.opencontainers.image.created="2026-04-10"
